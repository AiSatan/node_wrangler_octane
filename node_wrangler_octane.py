...
octane_shader_node_layout = (
    ('ShaderNodeOctDiffuseMat', 'ShaderNodeOctDiffuseMat', 'ShaderNodeOctDiffuseMat'),
    ('ShaderNodeOctGlossyMat', 'ShaderNodeOctGlossyMat', 'ShaderNodeOctGlossyMat'),
    ('ShaderNodeOctSpecularMat', 'ShaderNodeOctSpecularMat', 'ShaderNodeOctSpecularMat'),
    ('ShaderNodeOctMixMat', 'ShaderNodeOctMixMat', 'ShaderNodeOctMixMat'),
    ('ShaderNodeOctPortalMat', 'ShaderNodeOctPortalMat', 'ShaderNodeOctPortalMat'),
    ('ShaderNodeOctShadowCatcherMat', 'ShaderNodeOctShadowCatcherMat', 'ShaderNodeOctShadowCatcherMat'),
    ('ShaderNodeOctToonMat', 'ShaderNodeOctToonMat', 'ShaderNodeOctToonMat'),
    ('ShaderNodeOctMetalMat', 'ShaderNodeOctMetalMat', 'ShaderNodeOctMetalMat'),
    ('ShaderNodeOctUniversalMat', 'ShaderNodeOctUniversalMat', 'ShaderNodeOctUniversalMat'),
    ('ShaderNodeOctLayeredMat', 'ShaderNodeOctLayeredMat', 'ShaderNodeOctLayeredMat'),
    ('ShaderNodeOctCompositeMat', 'ShaderNodeOctCompositeMat', 'ShaderNodeOctCompositeMat'),
    ('ShaderNodeOctHairMat', 'ShaderNodeOctHairMat', 'ShaderNodeOctHairMat'),

)
octane_layers_node_layout = (
    ('ShaderNodeOctGroupLayer', 'ShaderNodeOctGroupLayer', 'ShaderNodeOctGroupLayer'),
    ('ShaderNodeOctDiffuseLayer', 'ShaderNodeOctGroupLayer', 'ShaderNodeOctGroupLayer'),
    ('ShaderNodeOctMetallicLayer', 'ShaderNodeOctMetallicLayer', 'ShaderNodeOctMetallicLayer'),
    ('ShaderNodeOctSheenLayer', 'ShaderNodeOctSheenLayer', 'ShaderNodeOctSheenLayer'),
    ('ShaderNodeOctSpecularLayer', 'ShaderNodeOctSpecularLayer', 'ShaderNodeOctSpecularLayer'),
...
octane_emission_node_layout = (
    ('ShaderNodeOctBlackBodyEmission', 'ShaderNodeOctBlackBodyEmission', 'ShaderNodeOctBlackBodyEmission'),
    ('ShaderNodeOctTextureEmission', 'ShaderNodeOctTextureEmission', 'ShaderNodeOctTextureEmission'),
    ('ShaderNodeOctToonDirectionLight', 'ShaderNodeOctToonDirectionLight', 'ShaderNodeOctToonDirectionLight'),
    ('ShaderNodeOctToonPointLight', 'ShaderNodeOctToonPointLight', 'ShaderNodeOctToonPointLight'),

)
octane_mediums_node_layout = (
    ('ShaderNodeOctAbsorptionMedium', 'ShaderNodeOctAbsorptionMedium', 'ShaderNodeOctAbsorptionMedium'),
    ('ShaderNodeOctScatteringMedium', 'ShaderNodeOctScatteringMedium', 'ShaderNodeOctScatteringMedium'),
    ('ShaderNodeOctVolumeMedium', 'ShaderNodeOctVolumeMedium', 'ShaderNodeOctVolumeMedium'),
    ('ShaderNodeOctRandomWalkMedium', 'ShaderNodeOctRandomWalkMedium', 'ShaderNodeOctRandomWalkMedium'),

)
octane_transfroms_node_layout = (
    ('ShaderNodeOctScaleTransform', 'ShaderNodeOctScaleTransform', 'ShaderNodeOctScaleTransform'),
    ('ShaderNodeOctRotateTransform', 'ShaderNodeOctRotateTransform', 'ShaderNodeOctRotateTransform'),
    ('ShaderNodeOctFullTransform', 'ShaderNodeOctFullTransform', 'ShaderNodeOctFullTransform'),
    ('ShaderNodeOct2DTransform', 'ShaderNodeOct2DTransform', 'ShaderNodeOct2DTransform'),
    ('ShaderNodeOct3DTransform', 'ShaderNodeOct3DTransform', 'ShaderNodeOct3DTransform'),

)
octane_projections_node_layout = (
    ('ShaderNodeOctBoxProjection', 'ShaderNodeOctBoxProjection', 'ShaderNodeOctBoxProjection'),
    ('ShaderNodeOctCylProjection', 'ShaderNodeOctCylProjection', 'ShaderNodeOctCylProjection'),
    ('ShaderNodeOctPerspProjection', 'ShaderNodeOctPerspProjection', 'ShaderNodeOctPerspProjection'),
    ('ShaderNodeOctSphericalProjection', 'ShaderNodeOctSphericalProjection', 'ShaderNodeOctSphericalProjection'),
    ('ShaderNodeOctUVWProjection', 'ShaderNodeOctUVWProjection', 'ShaderNodeOctUVWProjection'),
    ('ShaderNodeOctXYZProjection', 'ShaderNodeOctXYZProjection', 'ShaderNodeOctXYZProjection'),
    ('ShaderNodeOctTriplanarProjection', 'ShaderNodeOctTriplanarProjection', 'ShaderNodeOctTriplanarProjection'),
    ('ShaderNodeOctOSLUVProjection', 'ShaderNodeOctOSLUVProjection', 'ShaderNodeOctOSLUVProjection'),
    ('ShaderNodeOctOSLProjection', 'ShaderNodeOctOSLProjection', 'ShaderNodeOctOSLProjection'),

)
octane_values_node_layout = (
    ('ShaderNodeOctFloatValue', 'ShaderNodeOctFloatValue', 'ShaderNodeOctFloatValue'),
    ('ShaderNodeOctIntValue', 'ShaderNodeOctIntValue', 'ShaderNodeOctIntValue'),
    ('ShaderNodeOctSunDirectionValue', 'ShaderNodeOctSunDirectionValue', 'ShaderNodeOctSunDirectionValue'),
    ('ShaderNodeOctTextureReferenceValue', 'ShaderNodeOctTextureReferenceValue', 'ShaderNodeOctTextureReferenceValue'),
)
octane_cameras_node_layout = (
    ('ShaderNodeOctOSLCamera', 'ShaderNodeOctOSLCamera', 'ShaderNodeOctOSLCamera'),
    ('ShaderNodeOctOSLBakingCamera', 'ShaderNodeOctOSLBakingCamera', 'ShaderNodeOctOSLBakingCamera'),
)
octane_vectrons_node_layout = (
    ('ShaderNodeOctVectron', 'ShaderNodeOctVectron', 'ShaderNodeOctVectron'),
)
octane_roundedges_node_layout = (
    ('ShaderNodeOctRoundEdges', 'ShaderNodeOctRoundEdges', 'ShaderNodeOctRoundEdges'),
)
octane_enviroment_node_layout = (
    ('ShaderNodeOctTextureEnvironment', 'ShaderNodeOctTextureEnvironment', 'ShaderNodeOctTextureEnvironment'),
    ('ShaderNodeOctDaylightEnvironment', 'ShaderNodeOctDaylightEnvironment', 'ShaderNodeOctDaylightEnvironment'),
    ('ShaderNodeOctPlanetaryEnvironment', 'ShaderNodeOctPlanetaryEnvironment', 'ShaderNodeOctPlanetaryEnvironment'),
)
