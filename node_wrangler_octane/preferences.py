...
kmi_defs = (
    ...
    # Preview Node
    ("node.nw_add_viewer", 'LEFTMOUSE', 'PRESS', True, True,
     False, (('run_in_geometry_nodes', False),), n_("Preview node output")),
    ("node.nw_add_viewer", 'LEFTMOUSE', 'PRESS', False, True,
     True, (('run_in_geometry_nodes', True),), n_("Preview node output")),
    # Reload Images
